...
/**
 * Description of recommandations
 *
 * @author Jout
 */
class recommandations extends Controller {
    ...
    public function vote() {
        ...
        require '../modeles/Recommandation.php';
        ...
        $em->setId_emis($id);
        $vt = new Recommandation(0, $vote, 0, '', $emp, $em);
        echo '<br><pre>';
        print_r($_POST);
        echo '<br></pre>';
        $vt->recommander($this->manager);
    }
        public function get(){
        return $this->view;
    }
